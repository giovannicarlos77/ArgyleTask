...
class Scanner:
            ...
            try:
                ...
                if cookies:
                    ...
                    if  DriverUtils.search_element(self.driver, By.XPATH, '//*[@id="login_answer"]'):
                        ...
                        if (Utils.check_text(self.driver, "Oops! Answer is incorrect.") or Utils.check_text(self.driver,
                                "Help is on the way!") or Utils.check_text(self.driver,"Incorrect answer.")):
    ...
    def _extract_data(self):
        try:
            ...
            #If cookie has some time, maybe needs to put password again
            if DriverUtils.search_element(self.driver, By.XPATH, '//*[@id="sensitiveZone_password"]'):
                self.driver.find_element(By.XPATH, '//*[@id="sensitiveZone_password"]').send_keys(self.password)
                DriverUtils.wait_and_click(self.driver, By.XPATH, '//*[@id="control_continue"]/span', 5)
                cookies = self.driver.get_cookies()
                save_cookies(cookies, self.mail)
